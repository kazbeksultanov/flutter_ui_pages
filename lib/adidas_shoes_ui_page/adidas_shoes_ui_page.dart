...
import 'package:flutter_ui_pages/adidas_shoes_ui_page/utils.dart';
import 'package:flutter_ui_pages/adidas_shoes_ui_page/data.dart';

class AdidasShoesUiPage extends StatefulWidget {
  @override
  _AdidasShoesUiPageState createState() => _AdidasShoesUiPageState();
}

class _AdidasShoesUiPageState extends State<AdidasShoesUiPage> {
  @override
...
//    width: MediaQuery.of(context).size.width,
      // height was 245 need to check with baseHeight
        ...
        children: <Widget>[
          Stack(
            children: <Widget>[
              Container(
                child: Image.asset(
                  'assets/adidas_shoes_ui_page/adidas.png',
                  width: double.infinity,
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Container(
                    ...
                    child: Image.asset('assets/adidas_shoes_ui_page/360.png'),
                  ),
                ),
              )
            ],
          ...
          Padding(
            ...
            child: AnimatedCrossFade(
              firstChild: Text(
                desc,
                maxLines: 2,
                style: TextStyle(color: Colors.white, fontSize: screenAwareSize(10.0, context), fontFamily: 'Motserrat-Medium'),
              ),
              secondChild: Text(
                desc,
//                maxLines: 2,
          ...
          Padding(
            ...
            child: Text(
              'Price',
              style: TextStyle(color: Color(0xFF949598), fontFamily: 'Montserrat-SemiBold'),
            ),
          ),
          Container(
            width: double.infinity,
              ...
              children: <Widget>[
                ...
                Positioned(
                  right: -40.0,
                    bottom: -45.0,
                    child: Image.asset(
                  'assets/adidas_shoes_ui_page/cart.png',
